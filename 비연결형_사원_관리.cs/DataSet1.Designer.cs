...
namespace 수업_실습 {
    ...
    public partial class DataSet1 : global::System.Data.DataSet {
        ...
        public partial class EMPDataTable : global::System.Data.TypedTableBase<EMPRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public EMPRow AddEMPRow(string EMPNO, string ENAME, string DEPTNO, DEPTRow parentDEPTRowByEMP_FK1) {
...
namespace 수업_실습.DataSet1TableAdapters {
    ...
    public partial class DEPTTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::수업_실습.Properties.Settings.Default.ConnectionString;
        }
    ...
    public partial class EMPTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand = new global::Oracle.ManagedDataAccess.Client.OracleCommand();
            this._adapter.DeleteCommand.Connection = this.Connection;
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM ""C##5584980"".""EMP"" WHERE ((""EMPNO"" = :Original_EMPNO) AND ((:IsNull_ENAME = 1 AND ""ENAME"" IS NULL) OR (""ENAME"" = :Original_ENAME)) AND ((:IsNull_DEPTNO = 1 AND ""DEPTNO"" IS NULL) OR (""DEPTNO"" = :Original_DEPTNO)) AND ((:IsNull_DNAME = 1 AND ""DNAME"" IS NULL) OR (""DNAME"" = :Original_DNAME)))";
            this._adapter.DeleteCommand.CommandType = global::System.Data.CommandType.Text;
            global::Oracle.ManagedDataAccess.Client.OracleParameter param = new global::Oracle.ManagedDataAccess.Client.OracleParameter();
            ...
            this._adapter.InsertCommand = new global::Oracle.ManagedDataAccess.Client.OracleCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = "INSERT INTO \"C##5584980\".\"EMP\" (\"EMPNO\", \"ENAME\", \"DEPTNO\", \"DNAME\") VALUES (:EMP" +
                "NO, :ENAME, :DEPTNO, :DNAME)";
            this._adapter.InsertCommand.CommandType = global::System.Data.CommandType.Text;
            param = new global::Oracle.ManagedDataAccess.Client.OracleParameter();
            ...
            this._adapter.UpdateCommand = new global::Oracle.ManagedDataAccess.Client.OracleCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
            this._adapter.UpdateCommand.CommandText = @"UPDATE ""C##5584980"".""EMP"" SET ""EMPNO"" = :EMPNO, ""ENAME"" = :ENAME, ""DEPTNO"" = :DEPTNO, ""DNAME"" = :DNAME WHERE ((""EMPNO"" = :Original_EMPNO) AND ((:IsNull_ENAME = 1 AND ""ENAME"" IS NULL) OR (""ENAME"" = :Original_ENAME)) AND ((:IsNull_DEPTNO = 1 AND ""DEPTNO"" IS NULL) OR (""DEPTNO"" = :Original_DEPTNO)) AND ((:IsNull_DNAME = 1 AND ""DNAME"" IS NULL) OR (""DNAME"" = :Original_DNAME)))";
            this._adapter.UpdateCommand.CommandType = global::System.Data.CommandType.Text;
            param = new global::Oracle.ManagedDataAccess.Client.OracleParameter();
            param.ParameterName = "EMPNO";
            param.OracleDbTypeEx = global::Oracle.ManagedDataAccess.Client.OracleDbType.Varchar2;
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::Oracle.ManagedDataAccess.Client.OracleCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = "SELECT EMPNO, ENAME, DEPTNO, DNAME FROM \"C##5584980\".EMP";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
        }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Delete, true)]
        public virtual int Delete(string Original_EMPNO, string Original_ENAME, string Original_DEPTNO, string Original_DNAME) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Insert, true)]
        public virtual int Insert(string EMPNO, string ENAME, string DEPTNO, string DNAME) {
            if ((EMPNO == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string EMPNO, string ENAME, string DEPTNO, string DNAME, string Original_EMPNO, string Original_ENAME, string Original_DEPTNO, string Original_DNAME) {
            if ((EMPNO == null)) {
                throw new global::System.ArgumentNullException("EMPNO");
            }
            else {
            ...
            if ((Original_EMPNO == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[4].Value = ((string)(Original_EMPNO));
            }
            if ((Original_ENAME == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string ENAME, string DEPTNO, string DNAME, string Original_EMPNO, string Original_ENAME, string Original_DEPTNO, string Original_DNAME) {
            return this.Update(Original_EMPNO, ENAME, DEPTNO, DNAME, Original_EMPNO, Original_ENAME, Original_DEPTNO, Original_DNAME);
        }
    }
